...
func GetPastAssignmentsContent(username, password, quarter string) string {
	...
	"ctl00$plnMain$ddlReportCardRuns": "1",
	...
	finalResponse, _ := restyClient.R().EnableTrace().Get("https://hac.friscoisd.org/HomeAccess/Content/Student/Assignments.aspx")
