...
var request = URLRequest(url: URL(string: "https://gradual-deploy.vercel.app/students/currentclasses?username=john&password=doe")!,timeoutInterval: Double.infinity)
...
```Dart
var request = http.Request('GET', Uri.parse('https://gradual-deploy.vercel.app/students/currentclasses?username=john&password=doe'));
request.body = '''''';
