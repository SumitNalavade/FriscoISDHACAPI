...
const APIRoutes: IAPIRoute[] = [
    ...
    },
    {
        type: "POST",
        id: "predictedgpa",
        title: "Student Predicted GPA",
        description: "Get a students predicted GPA with their current grades",
        queryParameters: [
            {
                title: "weightedGPA",
                type: "number",
                description: "Student's weighted GPA in HAC",
                required: true
            },
            {
                title: "unweightedGPA",
                type: "number",
                description: "Student's unweighted GPA in HAC",
                required: true
            },
            {
                title: "studentGrade",
            ...
            {
                title: "currentclasses",
                type: "number",
                description: "Array of student class objects (You can use /currentclasses to get this)",
                required: true
            }
        ],
        exampleRequest: `axios.get("https://friscoisdhacapi.vercel.app/api/predictedgpa", {
            weightedGPA: 5.05,
            unweightedGPA: 3.88,
            studentGrade: 12,
            currentClasses: [
